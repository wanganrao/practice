...
function changeTopic(id){
    $("#idDivTopic_" + id).replaceWith( '<div id="idDivTopic_'+ id+' class="mf-div-topic" style="display:inline-block">' +                                       
                                        '<select id="selectTopic_'+id+'">'+
                                            ...
                                            '<option value="social-geography">Social Geography</option>'+
                                            '<option value="economic-geography">Economic Geography</option>'+
                                            '<option value="agriculture">Agriculture</option>'+
                                            '<option value="environment">Environment</option>'+
                                            '<option value="constitution">Constitution</option>'+
                                            '<option value="governance">Governance</option>'+
                                            '<option value="india-and-the-world">India And The World</option>'+
                                            '<option value="fundamentals-of-economics">Fundamentals of Economics</option>'+
                                        ...
                                        '</select>'+                                        
                                        '<button onclick="saveTopic('+id+');" class="discuss">Save</buttton>'+
                                    '</div>');
}

function saveTopic(id){
            var e = document.getElementById("selectTopic_"+id);
        var selectedTopic = e.options[e.selectedIndex].value;
        var params = "QID=" + id +
            "&Topic=" + selectedTopic ;
           
        console.log("saving topic: " + params);
        $.ajax({
            type: "POST",
            url: "/ajax/saveTopic",
            data: params,
            ...
            success: function(msg) {
                console.log("topic : " + selectedTopic + " saved.");
...
(function($) {
  ...
  $.facebox.settings = {
    loading_image : '/_files/images/website/loading.gif',
    close_image   : '/_files/images/website/closelabel.gif',
